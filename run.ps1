...
$app = Start-Process -FilePath "python" -ArgumentList "D:\BA\ba_mode-s_analysis\mode_s\main.py", "$args" -WorkingDirectory "D:\BA\ba_mode-s_analysis" -NoNewWindow -PassThru -Wait
